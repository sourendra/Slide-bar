...
import com.example.sidebarsteps.databinding.FragmentNavBinding;
...
//        return inflater.inflate(R.layout.fragment_nav, container, false);
    ...
    public void gotoEasySlideFragment(){
        mListener.navToFragment(new EasySlideFragment());
    }

    public void gotoConstraintSlideFragment(){
        mListener.navToFragment(new ConstraintSliderFragment());
    }
